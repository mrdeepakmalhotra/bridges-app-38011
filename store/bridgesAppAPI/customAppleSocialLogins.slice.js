...
export const modules_social_auth_apple_connect_create = createAsyncThunk("customAppleSocialLogins/modules_social_auth_apple_connect_create", async payload => {
  const response = await apiService.modules_social_auth_apple_connect_create(payload);
  return response.data;
});
export const modules_social_auth_apple_login_create = createAsyncThunk("customAppleSocialLogins/modules_social_auth_apple_login_create", async payload => {
  const response = await apiService.modules_social_auth_apple_login_create(payload);
  return response.data;
});
const initialState = {
  entities: [],
