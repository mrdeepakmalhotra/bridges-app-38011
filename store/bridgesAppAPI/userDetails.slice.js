...
export const rest_auth_user_read = createAsyncThunk("userDetails/rest_auth_user_read", async payload => {
  const response = await apiService.rest_auth_user_read(payload);
  return response.data;
});
export const rest_auth_user_update = createAsyncThunk("userDetails/rest_auth_user_update", async payload => {
  const response = await apiService.rest_auth_user_update(payload);
  return response.data;
});
export const rest_auth_user_partial_update = createAsyncThunk("userDetails/rest_auth_user_partial_update", async payload => {
